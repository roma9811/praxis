  ...
  return (
    <AnimatedPage>
      ...
      <div className="datenschutz-wrapper">
        ...
        <section className="datenschutz-block">
        ...
        <section className="datenschutz-block">
          ...
          <p>Details entnehmen Sie der Datenschutzerklärung von Hetzner: <a href="https://www.hetzner.com/de/legal/privacy-policy/" target="_blank" rel="noreferrer">https://www.hetzner.com/de/legal/privacy-policy/</a>.</p>
        ...
        <section className="datenschutz-block">
          ...
          <p>Wir weisen darauf hin, dass die Datenübertragung im Internet (z. B. bei der Kommunikation per E‑Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritter ist nicht möglich.</p>

          <h3>Hinweis zur verantwortlichen Stelle</h3>
          <p><strong>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</strong><br />
            Dres. Kathrin und Axel Sander<br />
            Bergstraße 31<br />
            69469 Weinheim<br />
            Telefon: 06201 62581<br />
            E‑Mail: info@hausarztpraxis‑sander.de</p>
          ...
          <p>WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE DAS RECHT, JEDERZEIT WIDERSPRUCH GEGEN DIE VERARBEITUNG SIE BETREFFENDER PERSONENBEZOGEN DER DATEN ZUM ZWECKE DERARTIGER WERBUNG EINZULEGEN; DIES GILT AUCH FÜR DAS PROFILING, SOWEIT ES MIT SOLCHER DIREKTWERBUNG IN VERBINDUNG STEHT. WENN SIE WIDERSPRECHEN, WERDEN IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH NACH ART. 21 ABS. 2 DSGVO).</p>
          ...
          <p>Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogenen Daten können Sie sich jederzeit an uns wenden.</p>
